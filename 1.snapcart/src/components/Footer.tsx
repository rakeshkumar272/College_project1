  ...
  return (
    ...
    >
      <div className='w-[90%] md:w-[80%] mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-green-500/40'>
        <div>
          <h2 className='text-2xl font-bold mb-3'>SpeedyMart</h2>
        ...
        <div>
          ...
          <ul className="space-y-2 text-green-100 text-sm">
            ...
            <li className="flex items-center gap-2">
              <Mail size={16} /> support@speedymart.in
            </li>
          </ul>
          {/* 🌐 Social Links */}
      ...
      <div className="text-center py-4 text-sm text-green-100 bg-green-800/40">
        © {new Date().getFullYear()} <span className="font-semibold">SpeedyMart</span>. All rights reserved.
      </div>
